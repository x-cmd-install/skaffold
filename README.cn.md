...
合计: **2,714,558** 行代码（覆盖前 5 种语言、共 **12406** 个文件）。
...
- **上游仓库**: <https://github.com/GoogleContainerTools/skaffold>
...
- **Star**: 15,891 · **Fork**: 1,703 · **开放 issue**: 4,280 · **贡献者**: 443

## 累计统计

- **发布数**: 200 · **已合并 PR**: 4873 · **开放 PR**: 77 · **已关闭 issue**: 3446 · **开放 issue**: 834 · **提交数**: 9242

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 0 | 4 | 12 | 2 | 2 | 8 |
| last60d | 2026-07-14 | 1 | 9 | 14 | 2 | 4 | 9 |
| 90d | 2026-06-14 | 2 | 24 | 19 | 2 | 12 | 26 |
| last180d | 2026-03-16 | 9 | 68 | 32 | 9 | 18 | 66 |
| 360d | 2025-09-17 | 14 | 127 | 52 | 14 | 36 | 124 |
| last720d | 2024-09-22 | 20 | 300 | 64 | 50 | 92 | 308 |
...
在 [repology.org](https://repology.org/project/skaffold) 上共有 **80** 个发行版报告此项目。**10** 个 ✅ 已是最新上游版本，**14** 个 ⚠️ 使用旧版本。
...
skaffold 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `skaffold` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/skaffold.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:06:38Z._
